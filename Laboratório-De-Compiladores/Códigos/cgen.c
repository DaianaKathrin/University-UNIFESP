...
//constroi a quadrupla referente ao nó da arvore
int make_quad(TreeNode * tree) {
    ...
    if (tree->nodekind==statementK) { 
        ...
        case idK:
            ...
            lista_quad->ultimo->op2.endereco = endr;
        ...
        case variableK:
            ...
            if(tree->child[0] != NULL){
               ...
               //verifica se o filho eh um const
                if(tree->child[0]->kind.exp == constantK){

                    //se for CONST busca o valor do vetor
...
//Constroi a lista de quadruplas
